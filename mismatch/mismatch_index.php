...
//Connect to appsvars and connectvars
...
//Show navigation menu
  ...
  while ($row = mysqli_fetch_array($data)) {
    if (is_file(MM_UPLOADPATH . $row['picture']) && filesize(MM_UPLOADPATH . $row['picture']) > 0) {
      echo '<tr><td><img src="' . MM_IMAGES . $row['picture'] . '" alt="' . $row['first_name'] . '" /></td>';
    }
    else {
      echo '<tr><td><img src="' . MM_IMAGES . 'nopic.jpg' . '" alt="' . $row['first_name'] . '" /></td>';
    }
