<?php 
	...
	$titleName = "Brushes and Accessories - Makeup.com";	//Stores the title of the webpage
			...
			<div class="contentWrapper">
				<?php 
					...
					$query = 'SELECT prod_id, prod_name, categories, description, price, rating, screenshot, in_stock
								FROM makeup_prods 
								WHERE categories="Brushes and Accessories"';
					...
					while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
						...
						echo '<article>
									<form action="addToCart.php" method="POST" id="buyButt" class="productButt">
